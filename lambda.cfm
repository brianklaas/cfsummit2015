...
<cfset lambdaFunctionToInvoke = "YOUR LAMBDA FUNCTION NAME GOES HERE" />
...
<cfif structKeyExists(URL, "invokeFunction")>
	<cfscript>
		...
		lambda = CreateObject('component', 'cfsummit2015.model.awsServiceFactory').init().createServiceObject('lambda');
